...
Begin VB.UserControl DirTree 
   ...
   ScaleHeight     =   3600
   ScaleWidth      =   4800
   Begin Scanner.ucTreeView tree1 
      Height          =   3255
      Left            =   0
      TabIndex        =   11
      Top             =   0
...
Public Sub LoadTreeDir(Optional cekSis As Boolean = True, Optional cekKomp As Boolean = False)
    ...
    'list untuk sistem
    'nodeSis = AddFolder(tree1, "System", False, , "::sistem", 6, 6)
    'AddFolder tree1, "System", True, nodeSis, "::spro", 7, 7
    'AddFolder tree1, "Startup", True, nodeSis, "::ssta", 9, 9
    
    ' Tambahkan Path Lain
    'NodePathLain = AddFolder(tree1, "Other Path", False, , "::plain", 0, 0)
